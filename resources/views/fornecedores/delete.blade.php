...
<div class="modal fade" id="delete-{{$fornecedor->id}}" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          <div class="modal-header">
              <h3 class="modal-title text-xl font-bold">Confirmação - #{{$fornecedor->id}}</h3>
          ...
          <div class="modal-footer flex justify-end pt-2 border-t border-gray-300" >
            ...
            <a href="{{ Route('fornecedores.destroy',['fornecedor' => $fornecedor->id])}}">
